...
anchorReadAlignments$sample.anchorReads <- NULL
adriftReadAlignments$sample.adriftReads <- NULL

adriftReadAlignmentsMetaData <- data.table(readID = adriftReadAlignments$readID.adriftReads, 
                                           randomLinkerSeq = adriftReadAlignments$randomLinkerSeq.adriftReads)
adriftReadAlignments$randomLinkerSeq.adriftReads <- NULL

anchorReadAlignmentsMetaData <- data.table(readID = anchorReadAlignments$readID.anchorReads,
                                           leaderSeq.anchorReads = anchorReadAlignments$leaderSeq.anchorReads)
anchorReadAlignments$leaderSeq.anchorReads <- NULL
...
# Set unsused aside until end to save memory since records will vecome duplicated during frag generation?
