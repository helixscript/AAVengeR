...
o <- tibble(pos = tbl2$posid)
o <- o[grepl('flip', o$pos),]
o$pos2 <- sub('flip_flip[-+]', '', o$pos)
o$pos2 <- sub('\\.\\d+$', '', o$pos2)
o$pos2 <- as.integer(o$pos2)
ggplot(o, aes(pos2)) + geom_histogram(bins = 500) + theme_bw() + labs(x = 'position', y = 'num events')
