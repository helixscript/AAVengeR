...
if(! dir.exists((file.path(opt$outputDir, 'demultiplex')))) stop('Error - could not create the demultiplex directory.')
...
dir.create(file.path(opt$outputDir, 'seqChunks'))
dir.create(file.path(opt$outputDir, 'tmp'))
dir.create(file.path(opt$outputDir, 'log'))
