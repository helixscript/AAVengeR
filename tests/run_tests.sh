...
Rscript $aavenger_test_dir/core_module_integration_test.R --run_type build --output_dir /data --number_of_cpus 64

Rscript $aavenger_test_dir/core_module_integration_test.R --run_type test --output_dir /data/fake_test2 --number_of_cpus 4 