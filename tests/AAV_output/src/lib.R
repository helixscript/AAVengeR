...
optionsSanityCheck <- function(opt){
  userRequired <- c('mode', 'softwareDir', 'outputDir', 'database_configFile', 'databaseConfigGroup',
...
createDBconnection <- function(){
  ...
  tryCatch({
    dbConnect(RMariaDB::MariaDB(), group = opt$databaseConfigGroup, default.file = opt$database_configFile)
  },
  error=function(cond) {
